...
en_blogs <- 
  readLines(paste("./../skims/skim_blogs_",filenum,".txt",sep=""),skipNul = TRUE,warn=FALSE)
...
write.csv(matrixDF_TDM_toplot,paste("./../skims/gram_1_blogs_",filenum,"_",fp,".txt",sep=""))

}

print("file completed")
print(paste("./../skims/skim_blogs_",filenum,".txt",sep=""))
}
...
#test:
fp=1  
paste("./../skims/skim_blogs_01_",fp,".txt",sep="")
