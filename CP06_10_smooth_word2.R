...
dataset_widenet_gram_2_twitter_in <- read.csv("./../skims/gram_2_blogs/gram_2_blogs_01_1.txt", stringsAsFactors = FALSE)
dataset_widenet_gram_3_twitter_in <- read.csv("./../skims/gram_3_blogs/gram_3_blogs_01_1.txt", stringsAsFactors = FALSE)

str(dataset_widenet_gram_2_twitter_in)
str(dataset_widenet_gram_3_twitter_in)

dataset_widenet_gram_2_twitter <- dataset_widenet_gram_2_twitter_in[1:100000,]
dataset_widenet_gram_3_twitter <- dataset_widenet_gram_3_twitter_in[1:100000,]
...
gram_2_twitter_freq <- gram_2_twitter_freq %>% 
  mutate(fake_freq = term_freq + 1.0*dnorm(rnorm(freq))/sum(dnorm(rnorm(freq))))
...
gram_2_twitter_input <- read.csv("./../model/test_02/dataset_gram_2_twitter.txt", 
...
gram_3_twitter_input <- read.csv("./../model/test_02/dataset_gram_3_twitter.txt", 
                                 stringsAsFactors = FALSE)
...
write.csv(output_dfsmooth_gram_3_3,"./../model/test_02/output_dfsmooth_gram_3_3.csv")
...
write.csv(output_dfsmooth_gram_3_2,"./../model/test_02/output_dfsmooth_gram_3_2.csv")
...
write.csv(output_dfsmooth_gram_2_3,"./../model/test_02/output_dfsmooth_gram_2_3.csv")
