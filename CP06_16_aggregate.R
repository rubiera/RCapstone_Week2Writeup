...
###################################
###################################
#### aggregate all gram_4

skim_dir = "C:/Users/rubiera-laptop/Documents/Tony Work/EID Data Science/Capstone/skims/gram_4_blogs"
file_list_gram_4_blogs <- list.files(skim_dir)
paste(skim_dir,file_list_gram_4_blogs[1],sep="/")

for (file in 1:length(file_list_gram_4_blogs)){
  
  # if the merged dataset doesn't exist, create it
  if (!exists("dataset_gram_4_blogs")){
    dataset_gram_4_blogs <- read.csv(paste(skim_dir,file_list_gram_4_blogs[file],sep="/"), header=TRUE)
  }
  
  # if the merged dataset does exist, append to it
  if (exists("dataset_gram_4_blogs")){
    temp_dataset <- read.csv(paste(skim_dir,file_list_gram_4_blogs[file],sep="/"), header=TRUE)
    dataset_gram_4_blogs<-rbind(dataset_gram_4_blogs, temp_dataset)
    rm(temp_dataset)
  }
  
}

head(dataset_gram_4_blogs)
str(dataset_gram_4_blogs)
class(dataset_gram_4_blogs)

write.csv(dataset_gram_4_blogs,"./dataset_gram_4_blogs.txt")

### twitter

skim_dir = "C:/Users/rubiera-laptop/Documents/Tony Work/EID Data Science/Capstone/skims/gram_4_twitter"
file_list_gram_4_twitter <- list.files(skim_dir)
paste(skim_dir,file_list_gram_4_twitter[1],sep="/")

for (file in 1:length(file_list_gram_4_twitter)){
  
  # if the merged dataset doesn't exist, create it
  if (!exists("dataset_gram_4_twitter")){
    dataset_gram_4_twitter <- read.csv(paste(skim_dir,file_list_gram_4_twitter[file],sep="/"), header=TRUE)
  }
  
  # if the merged dataset does exist, append to it
  if (exists("dataset_gram_4_twitter")){
    temp_dataset <- read.csv(paste(skim_dir,file_list_gram_4_twitter[file],sep="/"), header=TRUE)
    dataset_gram_4_twitter<-rbind(dataset_gram_4_twitter, temp_dataset)
    rm(temp_dataset)
  }
  
}

head(dataset_gram_4_twitter)
str(dataset_gram_4_twitter)
class(dataset_gram_4_twitter)

write.csv(dataset_gram_4_twitter,"./dataset_gram_4_twitter.txt")

dataset_gram_4 <- rbind(dataset_gram_4_blogs,dataset_gram_4_twitter)

head(dataset_gram_4)
str(dataset_gram_4)
class(dataset_gram_4)

dataset_gram_4_aggregated <- aggregate(freq ~ word, 
                                       data=dataset_gram_4,FUN=sum, 
                                       na.rm = TRUE) 

dataset_gram_4_aggregated$word <- as.character(dataset_gram_4_aggregated$word)
dataset_gram_4_aggregated <- filter(dataset_gram_4_aggregated, word != "")
head(dataset_gram_4_aggregated)
str(dataset_gram_4_aggregated)
class(dataset_gram_4_aggregated)

dataset_gram_4_aggregated <- dataset_gram_4_aggregated %>% arrange(desc(freq))

write.csv(dataset_gram_4_aggregated,"./dataset_gram_4_aggregated.txt")


###################################
###################################
###################################
#### aggregate all gram_5

skim_dir = "C:/Users/rubiera-laptop/Documents/Tony Work/EID Data Science/Capstone/skims/gram_5_blogs"
file_list_gram_5_blogs <- list.files(skim_dir)
paste(skim_dir,file_list_gram_5_blogs[1],sep="/")

for (file in 1:length(file_list_gram_5_blogs)){
  
  # if the merged dataset doesn't exist, create it
  if (!exists("dataset_gram_5_blogs")){
    dataset_gram_5_blogs <- read.csv(paste(skim_dir,file_list_gram_5_blogs[file],sep="/"), header=TRUE)
  }
  
  # if the merged dataset does exist, append to it
  if (exists("dataset_gram_5_blogs")){
    temp_dataset <- read.csv(paste(skim_dir,file_list_gram_5_blogs[file],sep="/"), header=TRUE)
    dataset_gram_5_blogs<-rbind(dataset_gram_5_blogs, temp_dataset)
    rm(temp_dataset)
  }
  
}

head(dataset_gram_5_blogs)
str(dataset_gram_5_blogs)
class(dataset_gram_5_blogs)

write.csv(dataset_gram_5_blogs,"./dataset_gram_5_blogs.txt")

### twitter

skim_dir = "C:/Users/rubiera-laptop/Documents/Tony Work/EID Data Science/Capstone/skims/gram_5_twitter"
file_list_gram_5_twitter <- list.files(skim_dir)
paste(skim_dir,file_list_gram_5_twitter[1],sep="/")

for (file in 1:length(file_list_gram_5_twitter)){
  
  # if the merged dataset doesn't exist, create it
  if (!exists("dataset_gram_5_twitter")){
    dataset_gram_5_twitter <- read.csv(paste(skim_dir,file_list_gram_5_twitter[file],sep="/"), header=TRUE)
  }
  
  # if the merged dataset does exist, append to it
  if (exists("dataset_gram_5_twitter")){
    temp_dataset <- read.csv(paste(skim_dir,file_list_gram_5_twitter[file],sep="/"), header=TRUE)
    dataset_gram_5_twitter<-rbind(dataset_gram_5_twitter, temp_dataset)
    rm(temp_dataset)
  }
  
}

head(dataset_gram_5_twitter)
str(dataset_gram_5_twitter)
class(dataset_gram_5_twitter)

write.csv(dataset_gram_5_twitter,"./dataset_gram_5_twitter.txt")

dataset_gram_5 <- rbind(dataset_gram_5_blogs,dataset_gram_5_twitter)

head(dataset_gram_5)
str(dataset_gram_5)
class(dataset_gram_5)

dataset_gram_5_aggregated <- aggregate(freq ~ word, 
                                       data=dataset_gram_5,FUN=sum, 
                                       na.rm = TRUE) 

dataset_gram_5_aggregated$word <- as.character(dataset_gram_5_aggregated$word)
dataset_gram_5_aggregated <- filter(dataset_gram_5_aggregated, word != "")
head(dataset_gram_5_aggregated)
str(dataset_gram_5_aggregated)
class(dataset_gram_5_aggregated)

dataset_gram_5_aggregated <- dataset_gram_5_aggregated %>% arrange(desc(freq))

write.csv(dataset_gram_5_aggregated,"./dataset_gram_5_aggregated.txt")
