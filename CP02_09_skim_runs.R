...
c9_blogs <- readLines(paste("./../skims/skim_blogs_",number,".txt",sep=""))
c9_news <- readLines(paste("./../skims/skim_news_",number,".txt",sep=""))
c9_twitter <- readLines(paste("./../skims/skim_twitter_",number,".txt",sep=""))
