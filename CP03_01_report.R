...
skim_blogs_01_medium <- en_blogs[1:5000]
...
findFreqTerms(txtTdmBi_blogs_2gram,4)
...
findFreqTerms(txtTdmBi_blogs_3gram,2)


write.csv(vocabulary_blog_3gram_0001,"./../course-data/vocabulary_blog_3gram_0001.csv")
...
filtermatrixDF_myTDM_blogs_01 <- filter(matrixDF_myTDM_blogs_01, freq >= 200)
