...
output_df_gram_2_2 <- data.frame(input_word1=character(), input_word2=character(),
...
str(output_df_gram_2_2)
head(output_df_gram_2_2)
nrow(output_df_gram_2_2)
  ...
  for (j in 1:nrow(gram_2_twitter_freq)){
    if(gram_2_twitter_input_split$word1[i] == gram_2_twitter_freq$word1[j]) {
      if (count == 1) {
        ...
        print(j)
        print("we are in gram_2 input word1")
        output_df_gram_2_2[i,1] <- gram_2_twitter_input_split$word1[i]
        print("we are in gram_2 input word2")
        output_df_gram_2_2[i,2] <- gram_2_twitter_input_split$word2[i]
        print("next word we predict")
        output_df_gram_2_2[i,3] <- gram_2_twitter_freq$word2[j]
        print("term freq")
        output_df_gram_2_2[i,4] <- gram_2_twitter_freq$fake_freq[j] 
      }
      if (count == 2) {
        print("next best word")        
        print("j")
        ...
        print(gram_2_twitter_input_split$word2[i])
        print("next word we predict")
        output_df_gram_2_2[i,5] <- gram_2_twitter_freq$word2[j]
        print("term freq")
        output_df_gram_2_2[i,6] <- gram_2_twitter_freq$fake_freq[j]
      }
      count <- count + 1
...
write.csv(output_df_gram_2_2,"./../model/test_01/output_df_gram_2_2.csv")


#build test output data frame gram_3
output_df_gram_3_3 <- data.frame(input_word1=character(), input_word2=character(),
                                 predict_word2_first=character(),predict_word2_first_freq=numeric(),
                                 predict_word2_second=character(), predict_word2_second_freq=numeric(),
                                 stringsAsFactors=FALSE)

str(output_df_gram_3_3)
head(output_df_gram_3_3)
nrow(output_df_gram_3_3)
  ...
  for (j in 1:nrow(gram_3_twitter_freq)){
    if(gram_3_twitter_input_split$word1[i] == gram_3_twitter_freq$word1[j]) {
      if (count == 1) {
        ...
        output_df_gram_3_3[i,1] <- gram_3_twitter_input_split$word1[i]
        print("we are in gram_3 input word2")
        output_df_gram_3_3[i,2] <- gram_3_twitter_input_split$word2[i]
        print("next word we predict")
        output_df_gram_3_3[i,3] <- gram_3_twitter_freq$word2[j]
        print("term freq")
        output_df_gram_3_3[i,4] <- gram_3_twitter_freq$fake_freq[j] 
      }
      if (count == 2) {
        print("next best word")        
        print("j")
        ...
        print("next word we predict")
        output_df_gram_3_3[i,5] <- gram_3_twitter_freq$word2[j]
        print("term freq")
        output_df_gram_3_3[i,6] <- gram_3_twitter_freq$fake_freq[j]
      }
      count <- count + 1
...
write.csv(output_df_gram_3_3,"./../model/test_01/output_df_gram_3_3.csv")

###########################################################################################
#build test output data frame gram_2  but using gram_3 as input 

output_df_gram_3_2 <- data.frame(input_word1=character(), input_word2=character(),
                                 predict_word2_first=character(),predict_word2_first_freq=numeric(),
                                 predict_word2_second=character(), predict_word2_second_freq=numeric(),
                                 stringsAsFactors=FALSE)

str(output_df_gram_3_2)
head(output_df_gram_3_2)
nrow(output_df_gram_3_2)
  ...
  for (j in 1:nrow(gram_2_twitter_freq)){
    if(gram_3_twitter_input_split$word1[i] == gram_2_twitter_freq$word1[j]) {
      if (count == 1) {
        ...
        print(j)
        print("we are in gram_3 input word1")
        output_df_gram_3_2[i,1] <- gram_3_twitter_input_split$word1[i]
        print("we are in gram_3 input word2")
        output_df_gram_3_2[i,2] <- gram_3_twitter_input_split$word2[i]
        print("next word we predict")
        output_df_gram_3_2[i,3] <- gram_2_twitter_freq$word2[j]
        print("term freq")
        output_df_gram_3_2[i,4] <- gram_2_twitter_freq$fake_freq[j] 
      }
      if (count == 2) {
        print("next best word")        
        print("j")
        ...
        print(gram_3_twitter_input_split$word2[i])
        print("next word we predict")
        output_df_gram_3_2[i,5] <- gram_2_twitter_freq$word2[j]
        print("term freq")
        output_df_gram_3_2[i,6] <- gram_2_twitter_freq$fake_freq[j]
      }
      count <- count + 1
...
write.csv(output_df_gram_3_2,"./../model/test_01/output_df_gram_3_2.csv")


#build test output data frame gram_3 from gram_2 input

output_df_gram_2_3 <- data.frame(input_word1=character(), input_word2=character(),
                                 predict_word2_first=character(),predict_word2_first_freq=numeric(),
                                 predict_word2_second=character(), predict_word2_second_freq=numeric(),
                                 stringsAsFactors=FALSE)

str(output_df_gram_2_3)
head(output_df_gram_2_3)
nrow(output_df_gram_2_3)
  ...
  for (j in 1:nrow(gram_3_twitter_freq)){
    if(gram_2_twitter_input_split$word1[i] == gram_3_twitter_freq$word1[j]) {
      if (count == 1) {
        ...
        print(j)
        print("we are in gram_3 input word1")
        output_df_gram_2_3[i,1] <- gram_2_twitter_input_split$word1[i]
        print("we are in gram_3 input word2")
        output_df_gram_2_3[i,2] <- gram_2_twitter_input_split$word2[i]
        print("next word we predict")
        output_df_gram_2_3[i,3] <- gram_3_twitter_freq$word2[j]
        print("term freq")
        output_df_gram_2_3[i,4] <- gram_3_twitter_freq$fake_freq[j] 
      }
      if (count == 2) {
        print("next best word")        
        print("j")
        ...
        print(gram_3_twitter_input_split$word2[i])
        print("next word we predict")
        output_df_gram_2_3[i,5] <- gram_3_twitter_freq$word2[j]
        print("term freq")
        output_df_gram_2_3[i,6] <- gram_3_twitter_freq$fake_freq[j]
      }
      count <- count + 1
...
write.csv(output_df_gram_2_3,"./../model/test_01/output_df_gram_2_3.csv")

########################
##### word3

#build test output data frame gram_3
output3_df_gram_3_3 <- data.frame(input_word2=character(), input_word3=character(),
...
str(output3_df_gram_3_3)
head(output3_df_gram_3_3)
nrow(output3_df_gram_3_3)
  ...
  for (j in 1:nrow(gram_3_twitter_freq)){
    if(gram_3_twitter_input_split$word2[i] == gram_3_twitter_freq$word2[j]) {
      if (count == 1) {
        ...
        print(j)
        print("we are in gram_3 input word1")
        output3_df_gram_3_3[i,1] <- gram_3_twitter_input_split$word2[i]
        print("we are in gram_3 input word2")
        output3_df_gram_3_3[i,2] <- gram_3_twitter_input_split$word3[i]
        print("next word we predict")
        output3_df_gram_3_3[i,3] <- gram_3_twitter_freq$word3[j]
        print("term freq")
        output3_df_gram_3_3[i,4] <- gram_3_twitter_freq$fake_freq[j] 
      }
      if (count == 2) {
        print("next best word")        
        print("j")
        ...
        print("next word we predict")
        output3_df_gram_3_3[i,5] <- gram_3_twitter_freq$word3[j]
        print("term freq")
        output3_df_gram_3_3[i,6] <- gram_3_twitter_freq$fake_freq[j]
      }
      count <- count + 1
...
write.csv(output3_df_gram_3_3,"./../model/test_01/output3_df_gram_3_3.csv")
