...
gram_4_aggr <- fread("./../skims/merged_grams/dataset_gram_4_aggregated.txt")
gram_5_aggr <- fread("./../skims/merged_grams/dataset_gram_5_aggregated.txt")
...
gram_4_aggr <- filter(gram_4_aggr, word != "")
gram_5_aggr <- filter(gram_5_aggr, word != "")

table(gram_1_aggr$freq)
table(gram_2_aggr$freq)
table(gram_3_aggr$freq)
table(gram_4_aggr$freq)
table(gram_5_aggr$freq)
...
#gram4: 13778038
#       1        2        3        4        5           
# 13440276   304198    18956     6261     2784

#gram5: 12354047
#        1        2        3        4        5      
# 12096202   240875     9807     3064     1375

gram_2_aggr_split_time <- gram_2_aggr_split
gram_3_aggr_split_time <- gram_3_aggr_split %>% filter(word1 == "time")

gram_4_aggr_split <- gram_4_aggr %>% separate(word, c("word1", "word2", "word3", "word4"), sep = " ")
gram_5_aggr_split <- gram_5_aggr %>% 
  separate(word, c("word1", "word2", "word3", "word4", "word5"), sep = " ")

str(gram_4_aggr_split)
str(gram_5_aggr_split)

gram_4_aggr_split_time <- gram_4_aggr_split %>% filter(word1 == "time")
str(gram_4_aggr_split_time)
gram_5_aggr_split_time <- gram_5_aggr_split %>% filter(word1 == "time")
str(gram_5_aggr_split_time)
...
write.csv(gram_4_aggr_split_time,"./../model/training/gram_4_aggr_split_time.txt")
write.csv(gram_5_aggr_split_time,"./../model/training/gram_5_aggr_split_time.txt")
